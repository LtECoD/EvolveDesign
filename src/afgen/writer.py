...
from boltz.data.types import (
    Record, Structure, Interface)
from boltz.data.write.mmcif import to_mmcif
from boltz.data.write.pdb import to_pdb


class Writer:
    def __init__(self, out_dir: Path, output_format: str="pdb"):
    ...
    def write(
        ...
        for model_idx in range(coords.shape[0]):
            ...
            # Save the structure
            struct_dir = self.out_dir / sub_dir if sub_dir is not None else self.out_dir
